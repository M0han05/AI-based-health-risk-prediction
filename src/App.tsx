...
import { Shield, Database, Lock, BarChart3, Brain, ChevronRight, Cpu, Globe, Users, HeartPulse, Hospital } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      {currentStep === 'registration' && !patient && !showNetwork && (
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {currentIdx === 4 && patient && !showMath && (
          <ExplainableAI patient={patient} onShowMath={() => setShowMath(true)} />
        )}
        {showMath && (
          <ModelMathematics onBack={() => setShowMath(false)} />
        )}
